An \openshmem program consists of a set of \acp{PE}'s
...
from main, the user has the option of calling \FUNC{shmem\_finalize} to
...
\begin{itemize}
  ...
  \item Implementations should avoid deferring the execution of one-sided
      ...
      available. For performance reasons, high-quality implementations should attempt 
      asynchronous delivery whenever possible. Additionally, the \openshmem
